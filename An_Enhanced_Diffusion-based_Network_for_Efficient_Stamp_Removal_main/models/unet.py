...
class DACblock(nn.Module):
    def __init__(self, channel):
        ...
        # self.conv2x2 = nn.Conv2d(channel, channel, kernel_size=3, dilation=1, padding=1)
...
if __name__ == "__main__":
    ...
    model.to(device)
    #print(net)
    input = torch.randn(1, 6, 24, 24).to(device) ### ？
    t = torch.randn(1, 6, 24, 24).to(device) ### ？
